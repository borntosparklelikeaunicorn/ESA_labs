    ...
    <xsl:template match="/">
        <html>
            <body>
                ...
                <form action="/api/classes/create" method="post" enctype="application/x-www-form-urlencoded">
